...
som.view_umatrix(bestmatches=True, labels=y, filename='output_som_d1/planar_map__umatrix')

# We can also zoom into a region of interest, for instance,
# the dense lower right corner:
som.view_umatrix(bestmatches=True, filename='output_som_d1/planar_map__umatrix_zoom', labels=y,
...
som.train(x)
som.view_umatrix(bestmatches=True, filename='output_som_d1/toroid_map__umatrix')
...
som.train(x)
som.view_umatrix(bestmatches=True, filename='output_som_d1/toroid_map_pca__umatrix')
